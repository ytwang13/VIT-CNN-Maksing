...
class ImageClassifierllp(ImageClassifier):
    ...
    def __init__(self,
        ...
        super(ImageClassifierllp, self).__init__(
            backbone, neck, head, pretrained, train_cfg,
    ...
    def _parameters(self):
        if self.with_neck:
            return list(self.neck._parameters()) + list(self.head._parameters())
        else:
            return list(self.head._parameters())